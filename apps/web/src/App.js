...
import { authApi, setToken, getToken, customerApi, vehicleApi, serviceOrderApi, reportingApi, adminApi } from './services/api';
// ============ STYLES ============
const S = {
...
function LandingPage({ onGetStarted, onLogin }) {
    return (_jsxs("div", { style: { minHeight: '100vh', background: 'linear-gradient(135deg, #0f172a 0%, #1e3a5f 50%, #0f172a 100%)' }, children: [_jsxs("nav", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 40px', maxWidth: 1200, margin: '0 auto' }, children: [_jsx("div", { style: { fontSize: 24, fontWeight: 800, color: 'white' }, children: "OtoServis" }), _jsxs("div", { style: { display: 'flex', gap: 16 }, children: [_jsx("button", { onClick: onLogin, style: { padding: '10px 20px', background: 'transparent', color: 'white', border: '1px solid rgba(255,255,255,0.3)', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer' }, children: "Giri\u015F Yap" }), _jsx("button", { onClick: onGetStarted, style: { padding: '10px 20px', background: '#2563eb', color: 'white', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer' }, children: "\u00DCcretsiz Dene" })] })] }), _jsxs("div", { style: { maxWidth: 1200, margin: '0 auto', padding: '80px 40px', textAlign: 'center' }, children: [_jsx("h1", { style: { fontSize: 56, fontWeight: 800, color: 'white', lineHeight: 1.2, marginBottom: 24 }, children: "Servisinizi Buluta Ta\u015F\u0131y\u0131n" }), _jsx("p", { style: { fontSize: 20, color: '#94a3b8', maxWidth: 600, margin: '0 auto 40px', lineHeight: 1.6 }, children: "M\u00FC\u015Fteri y\u00F6netimi, servis sipari\u015Fleri, stok takibi ve \u00F6n muhasebe. Hepsi tek platformda." }), _jsxs("div", { style: { display: 'flex', gap: 16, justifyContent: 'center', marginBottom: 80 }, children: [_jsx("button", { onClick: onGetStarted, style: { padding: '16px 32px', background: '#2563eb', color: 'white', border: 'none', borderRadius: 12, fontSize: 18, fontWeight: 700, cursor: 'pointer' }, children: "Hemen Ba\u015Fla" }), _jsx("button", { onClick: onLogin, style: { padding: '16px 32px', background: 'rgba(255,255,255,0.1)', color: 'white', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 12, fontSize: 18, fontWeight: 600, cursor: 'pointer' }, children: "Demo \u0130zle" })] }), _jsx("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, maxWidth: 900, margin: '0 auto' }, children: [
                        ...
                        ].map((f, i) => (_jsxs("div", { style: { background: 'rgba(255,255,255,0.05)', borderRadius: 16, padding: 24, textAlign: 'center' }, children: [_jsx("div", { style: { fontSize: 40, marginBottom: 12 }, children: f.icon }), _jsx("h3", { style: { color: 'white', fontSize: 18, fontWeight: 700, marginBottom: 8 }, children: f.title }), _jsx("p", { style: { color: '#94a3b8', fontSize: 14 }, children: f.desc })] }, i))) })] }), _jsx("div", { style: { textAlign: 'center', padding: '40px 20px', borderTop: '1px solid rgba(255,255,255,0.1)', color: '#64748b', fontSize: 14 }, children: "\u00A9 2026 OtoServis. T\u00FCm haklar\u0131 sakl\u0131d\u0131r." })] }));
}
// ============ ADMIN PANEL ============
function AdminPanel({ onBack }) {
    ...
    return (_jsxs("div", { style: S.page, children: [_jsxs("div", { style: { background: '#0f172a', padding: '16px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [_jsx("h1", { style: { color: 'white', fontSize: 20, fontWeight: 700, margin: 0 }, children: "S\u00FCper Admin Paneli" }), _jsx("button", { onClick: onBack, style: S.btnSecondary, children: "\u2190 Geri" })] }), _jsxs("div", { style: { padding: 32 }, children: [_jsxs("div", { style: S.statGrid, children: [_jsxs("div", { style: S.statCard, children: [_jsx("div", { style: S.statLabel, children: "Toplam Servis" }), _jsx("div", { style: S.statValue, children: stats?.tenantCount || 0 })] }), _jsxs("div", { style: S.statCard, children: [_jsx("div", { style: S.statLabel, children: "Aktif Servis" }), _jsx("div", { style: { ...S.statValue, color: '#16a34a' }, children: stats?.activeTenants || 0 })] }), _jsxs("div", { style: S.statCard, children: [_jsx("div", { style: S.statLabel, children: "Toplam Kullan\u0131c\u0131" }), _jsx("div", { style: S.statValue, children: stats?.userCount || 0 })] }), _jsxs("div", { style: S.statCard, children: [_jsx("div", { style: S.statLabel, children: "Toplam M\u00FC\u015Fteri" }), _jsx("div", { style: S.statValue, children: stats?.customerCount || 0 })] }), _jsxs("div", { style: S.statCard, children: [_jsx("div", { style: S.statLabel, children: "Toplam Ara\u00E7" }), _jsx("div", { style: S.statValue, children: stats?.vehicleCount || 0 })] }), _jsxs("div", { style: S.statCard, children: [_jsx("div", { style: S.statLabel, children: "Toplam Sipari\u015F" }), _jsx("div", { style: S.statValue, children: stats?.serviceOrderCount || 0 })] })] }), _jsxs("div", { style: S.card, children: [_jsx("h3", { style: { marginBottom: 16, fontWeight: 600 }, children: "Kay\u0131tl\u0131 Servisler" }), _jsxs("table", { style: S.table, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { style: S.th, children: "Firma" }), _jsx("th", { style: S.th, children: "Slug" }), _jsx("th", { style: S.th, children: "Durum" }), _jsx("th", { style: S.th, children: "Kullan\u0131c\u0131" }), _jsx("th", { style: S.th, children: "M\u00FC\u015Fteri" }), _jsx("th", { style: S.th, children: "Ara\u00E7" }), _jsx("th", { style: S.th, children: "Sipari\u015F" }), _jsx("th", { style: S.th, children: "\u0130\u015Flem" })] }) }), _jsx("tbody", { children: tenants.map(t => (_jsxs("tr", { children: [_jsx("td", { style: S.td, children: _jsx("strong", { children: t.name }) }), _jsx("td", { style: S.td, children: t.slug }), _jsx("td", { style: S.td, children: _jsxs("select", { value: t.status, onChange: e => handleStatusChange(t.id, e.target.value), style: { ...S.select, width: 'auto', padding: '4px 8px', fontSize: 12 }, children: [_jsx("option", { value: "ACTIVE", children: "Aktif" }), _jsx("option", { value: "SUSPENDED", children: "Ask\u0131ya Al" }), _jsx("option", { value: "TRIAL", children: "Deneme" })] }) }), _jsx("td", { style: S.td, children: t.stats.userCount }), _jsx("td", { style: S.td, children: t.stats.customerCount }), _jsx("td", { style: S.td, children: t.stats.vehicleCount }), _jsx("td", { style: S.td, children: t.stats.serviceOrderCount }), _jsx("td", { style: S.td, children: _jsx("button", { style: S.btnSecondary, onClick: () => handleViewDetail(t.id), children: "Detay" }) })] }, t.id))) })] })] })] }), selectedTenant && (_jsx("div", { style: S.modal, onClick: () => setSelectedTenant(null), children: _jsxs("div", { style: S.modalContent, onClick: e => e.stopPropagation(), children: [_jsxs("div", { style: S.modalTitle, children: [selectedTenant.name, " - Detay"] }), _jsxs("div", { style: { display: 'grid', gap: 12, marginBottom: 20 }, children: [_jsxs("div", { children: [_jsx("strong", { children: "Slug:" }), " ", selectedTenant.slug] }), _jsxs("div", { children: [_jsx("strong", { children: "Durum:" }), " ", selectedTenant.status] }), _jsxs("div", { children: [_jsx("strong", { children: "Kay\u0131t Tarihi:" }), " ", new Date(selectedTenant.createdAt).toLocaleDateString('tr-TR')] }), _jsxs("div", { children: [_jsx("strong", { children: "Kullan\u0131c\u0131 Say\u0131s\u0131:" }), " ", selectedTenant.stats.userCount] }), _jsxs("div", { children: [_jsx("strong", { children: "M\u00FC\u015Fteri Say\u0131s\u0131:" }), " ", selectedTenant.stats.customerCount] }), _jsxs("div", { children: [_jsx("strong", { children: "Ara\u00E7 Say\u0131s\u0131:" }), " ", selectedTenant.stats.vehicleCount] }), _jsxs("div", { children: [_jsx("strong", { children: "Sipari\u015F Say\u0131s\u0131:" }), " ", selectedTenant.stats.serviceOrderCount] })] }), _jsx("h4", { style: { marginBottom: 12, fontWeight: 600 }, children: "Kullan\u0131c\u0131lar" }), _jsxs("table", { style: S.table, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { style: S.th, children: "Ad Soyad" }), _jsx("th", { style: S.th, children: "E-posta" }), _jsx("th", { style: S.th, children: "Durum" })] }) }), _jsx("tbody", { children: selectedTenant.users?.map((u) => (_jsxs("tr", { children: [_jsxs("td", { style: S.td, children: [u.firstName, " ", u.lastName] }), _jsx("td", { style: S.td, children: u.email }), _jsx("td", { style: S.td, children: _jsx("span", { style: S.badge(u.status === 'ACTIVE' ? 'green' : 'red'), children: u.status }) })] }, u.id))) })] }), _jsx("div", { style: { display: 'flex', justifyContent: 'flex-end', marginTop: 20 }, children: _jsx("button", { style: S.btnSecondary, onClick: () => setSelectedTenant(null), children: "Kapat" }) })] }) }))] }));
}
// ============ MAIN APP ============
export function App() {
